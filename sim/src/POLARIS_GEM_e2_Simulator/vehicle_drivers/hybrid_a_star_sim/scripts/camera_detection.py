...
class YOLOv5Node:
    def __init__(self):
        # # supposed to suppress tf warnings, not rly working ngl 
        # rospy.set_param("~suppress_tf_warnings", True)
        # if rospy.get_param("~suppress_tf_warnings", True):
        #     import logging
        #     logging.getLogger('tf2_ros.buffer').setLevel(logging.ERROR)
        #     logging.getLogger('tf2_ros.static_transform_broadcaster').setLevel(logging.ERROR)
